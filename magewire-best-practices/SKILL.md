...
- Rate limiting is disabled by default; choose the request or component variant explicitly and still authorize every action
...
- Facades were removed in Magewire 3.3 — expose services through Magento DI or the 3.5 application container
...
- Lazy-load expensive components with `#[Lazy]` or `magewire:component:lazy`
